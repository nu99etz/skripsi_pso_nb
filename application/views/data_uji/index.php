        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <table id="data-uji" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama Pasien</th>
                        ...
                        <button style="float: right;" action="<?php echo base_url(); ?>data_uji/import_form" type="button" id="import" class="btn btn-sm btn-primary"><i class="fa fa-upload"></i> Import Excel</button>
...
<script>
    let _table = $('#data-uji');
    let _url = "<?php echo base_url(); ?>data_uji/ajax";
    ...
    $(document).on('submit', 'form#import_uji', function() {
